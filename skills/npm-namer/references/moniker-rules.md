...
- The corpus is a snapshot. Refresh by running `node skill-scripts/npm-namer/refresh-popular-names.mjs --top 15000` then `pnpm skill-tools sync-scripts`. Cadence: monthly.
